...
public class Lab_6 {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[2]/div/form/div[1]/input")).click();
		String emailid = "kaviyanjali17@gmail.com";
		WebElement email = driver.findElement(By.id("input-email"));
		email.sendKeys(emailid);
		System.out.println("Email:"+emailid);
		driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[2]/div/form/div[2]/input")).click();
